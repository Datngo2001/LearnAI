...
class Node:
    ...
    def expand(self, problem):
        ...
        # For each posible action find child node and put result in an array
    ...
    def solution(self):
        ...
        # For each node in path put action in an array
...
def depth_limited_search(problem, limit=50):
    return recursive_DLS(node=Node(problem.initial), problem=problem, limit=limit)
...
class EightPuzzleProblem:
    ...
    def result(self, state, action):
        ...
        # The square that will swap with blank
